# python caption.py -m ckpt.pth.tar -wm wordmap.json
...
def preprocess_image(img=None, file_path=None):
    ################# LOADING THE IMAGE ############################
